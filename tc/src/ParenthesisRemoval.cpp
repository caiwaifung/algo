...
private:
    ...
    void test_case_0() {
        string Arg0 = "()()()()()";
        int Arg1 = 1;
        verify_case(0, Arg1, countWays(Arg0));
    }
    void test_case_1() {
        string Arg0 = "(((())))";
        int Arg1 = 24;
        verify_case(1, Arg1, countWays(Arg0));
    }
    void test_case_2() {
        string Arg0 = "((()()()))";
        int Arg1 = 54;
        verify_case(2, Arg1, countWays(Arg0));
    }
    void test_case_3() {
        string Arg0 = "(())(())(())";
        int Arg1 = 8;
        verify_case(3, Arg1, countWays(Arg0));
    }
    void test_case_4() {
        string Arg0 = "((((())((((((((((()((((((()))))())))))()))))))))))";
        int Arg1 = 948334170;
        verify_case(4, Arg1, countWays(Arg0));
    }
