...
class ObtuseTrianglesDiv1 {
  ...
  private:
    ...
    void test_case_0() {
        ...
        verify_case(0, Arg2, findObtuseTriangles(Arg0, Arg1));
    }
    void test_case_1() {
        int Arg0 = 3;
        int Arg1 = 1;
        long Arr2[] = {};
        vector<long long> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
        verify_case(1, Arg2, findObtuseTriangles(Arg0, Arg1));
    }
    void test_case_2() {
        int Arg0 = 2;
        int Arg1 = 2;
        long Arr2[] = {200040005, 300070006};
        vector<long long> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
        verify_case(2, Arg2, findObtuseTriangles(Arg0, Arg1));
    }
    void test_case_3() {
        int Arg0 = 10;
        int Arg1 = 6;
        long Arr2[] = {1000160025, 1100170024, 1200190023,
                       1300210026, 1400150022, 1800200027};
        vector<long long> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
        verify_case(3, Arg2, findObtuseTriangles(Arg0, Arg1));
    }
    void test_case_4() {
        int Arg0 = 8;
        int Arg1 = 5;
        long Arr2[] = {800130020, 900140019, 1000170021, 1100120018,
                       1500160022};
        vector<long long> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
        verify_case(4, Arg2, findObtuseTriangles(Arg0, Arg1));
    }
